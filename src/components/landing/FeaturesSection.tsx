...
import { Bot, MessageSquare, Sparkles, Image } from 'lucide-react';
...
const features = [
  ...
  },
  {
    ...
    description: 'Create stunning images with just a text description using our powerful AI image generator.'
  },
  {
...
const FeatureCard = ({ feature, index }: { feature: typeof features[0], index: number }) => {
  return (
    <motion.div 
      className="bg-white dark:bg-slate-800 p-6 sm:p-8 rounded-xl shadow-md border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-all"
    ...
    >
      <div className="inline-flex h-14 w-14 items-center justify-center rounded-xl bg-blue-100 dark:bg-slate-700/50 mb-6 transform transition-transform duration-300 hover:rotate-6">
        {feature.icon}
      </div>
